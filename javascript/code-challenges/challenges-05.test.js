...
const countNumberOfElements = (arr) => {
  // Solution code here...
  const newArr = arr.reduce((count) => count + 1, 0);
  return newArr;
};
...
const returnNames = (arr) => {
  // Solution code here...
  const newArr = arr.reduce((accumulator, data) => {
...
const reversedString = (str) => {
  // Solution code here...
  const newStr = str.split("").reduce((accumulator, currentValue) => {
...
const countNumberOfChildren = (arr) => {
  // Solution code here...
  const totalChildren = arr.reduce((accumulator, character) => {
